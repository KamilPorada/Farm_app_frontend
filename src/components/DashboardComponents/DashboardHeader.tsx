...
export default function DashboardHeader({ year, setYear, toDate, setToDate }: Props) {
	...
	return (
		<div className='flex flex-col gap-4 md:flex-row md:items-start md:justify-between'>
			...
			<div className='flex flex-col gap-2'>
				...
				{/* PODTYTUŁ */}
				<p className='text-sm text-gray-500 '>Najważniejsze informacje o Twoim gospodarstwie w jednym widoku.</p>
			</div>
		</div>
	)
}
