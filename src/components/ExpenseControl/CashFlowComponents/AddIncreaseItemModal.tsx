...
export default function AddIncreaseItemModal({
	title,
	amount,
	onTitleChange,
	onAmountChange,
	...
	return (
		<div className='fixed inset-0 z-50 flex items-center justify-center bg-black/40'>
			<div className='w-full max-w-lg rounded-lg bg-white p-6 shadow-lg'>
				<h3 className='mb-2 text-lg font-semibold'>Nowy przychód</h3>
				<p className='mb-4 text-sm text-gray-500'>Dodaj nową pozycję przychodu do wybranej kategorii.</p>
