...
export default function SectionHeader({ title, description, buttonTitle, year, setYear, onAdd }: Props) {
	...
	return (
		<div className='flex flex-col gap-4 md:flex-row md:items-start md:justify-between'>
			...
			<SystemButton onClick={onAdd} className='normal-case w-full justify-center md:w-auto'>
